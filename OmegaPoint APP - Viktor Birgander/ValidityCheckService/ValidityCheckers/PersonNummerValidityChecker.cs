...
{
    public class PersonNummerValidityChecker : ValidityChecker
    {
        ...
        private BirthdateValidityCheck birthdateValidityCheck = new();
        private LuhnsValidityCheck luhnsValidityCheck = new();
        private IdentificationNumberCleaner identificationNumberCleaner = new();

        /// <summary>
        /// Runs all necessary checks to determine if a provided number is a valid Personnummer
        /// </summary>
        ...
        public override bool AllChecksValid(string number)
        {
            ...
            return RunValidityCheck(birthdateValidityCheck, cleanedNumber) && RunValidityCheck(luhnsValidityCheck, cleanedNumber);
        }
    }
}
